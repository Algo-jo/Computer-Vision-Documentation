...
def extract_face(img):
    ...
    if len(faces) > 0:
        ...
        return preprocess(face), (x,y,w,h)
...
def train_and_load_model():
    ...
    for subject in subjects:
        ...
        for filename in os.listdir(subject_path):
            ...
            print(f"{predicted_subject}: {confidence}")
...
def predict_img(img_path):
    ...
    print(f"{img_path} predicted as {predicted_subject} with score: {confidence}")
